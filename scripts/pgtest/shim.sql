...
create table if not exists programs (id text primary key, name text, country text, cc text, levels text[], deadline_md text, deadline text, duplicate_of text, funding text, updated_at timestamptz default now());
