...
class H(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if self.path.startswith("/supabase/rest/v1/rpc/"):
            ...
            if fn == "founder_digest_due":
                return self._json(200, STATE.get("founder") or {"ok": True, "day": "2026-09-05", "milestone": 120, "stats": {}, "prev": {}, "top_channels": [], "recipients": []})
            if fn == "tg_week_due":
        ...
        if self.path == "/__reset": STATE["rpc"].clear(); STATE["due"]=[]; STATE["week"]={}; STATE["ws"]=None; STATE["founder"]=None; return self._json(200, {"ok": True})
        return self._json(404, {})
