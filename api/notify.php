...
/* Общий кап защищает WhatsApp-квоту, но письмо о реальной заявке дешёвое —
   его шлём всегда. Раньше после 150 обращений в сутки владелец молча
   переставал узнавать о новых клиентах до полуночи. */
$rlAll = rate_check('all:notify', 150);
$GLOBALS['NOTIFY_MAIL_ONLY'] = !$rlAll['ok'];
