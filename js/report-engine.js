...
(function (root, factory) {
  ...
  var PROGRAMS = [
    ...
    { id: "boell", name: "Heinrich-Böll-Stiftung (Германия)", country: "Германия", cc: "de", levels: ["master", "phd"], baseAdm: .15, baseSch: .15, req: { academics: 7, language: 6.5, budget: 0 }, deadline: "1 марта", note: "Официально: Heinrich-Böll-Stiftung Scholarship for International Students (Studienwerk). Только магистратура и PhD (бакалавриат для иностранцев закрыт). Приоритет — кандидаты из стран DAC-списка (Казахстан входит), ещё не проживающие в Германии. Отбор с интервью, важна общественная активность, экология, права человека; немецкий B2 обязателен.", funding: "Ежемесячная стипендия по ставкам BMBF (ориентир: ~€992/мес магистратура, ~€1 450/мес PhD) + доплаты на медстраховку/семью; обучение в гос. вузах Германии бесплатно. Продолжительность — весь нормативный срок программы.", source_url: "https://www.boell.de/en/application" },
    { id: "kas_intl", name: "Konrad-Adenauer-Stiftung (Германия)", country: "Германия", cc: "de", levels: ["master", "phd"], baseAdm: .12, baseSch: .12, req: { academics: 7, language: 6.5, budget: 0 }, deadline: "15 июля", note: "Официально: Konrad-Adenauer-Stiftung — International Talent Development (scholarships for international students and doctoral candidates). Нужен немецкий B2 даже для англоязычных программ, отбор с интервью (в т.ч. в региональных офисах KAS). Ценностный фонд ХДС: важна общественная/политическая активность. Возрастного лимита нет.", funding: "До €992/мес (магистратура, постдиплом) и до €1 400/мес (PhD) + доплаты на страховку; стандартно 2 года (магистратура) / 3 года (PhD). Обучение в гос. вузах бесплатно.", source_url: "https://www.kas.de/en/web/begabtenfoerderung-und-kultur/international-talent-development" },
    { id: "rosalux", name: "Rosa-Luxemburg-Stiftung (Германия)", country: "Германия", cc: "de", levels: ["master", "phd"], baseAdm: .12, baseSch: .12, req: { academics: 7, language: 6.5, budget: 0 }, deadline: "1 октября", note: "Официально: Rosa-Luxemburg-Stiftung — Scholarships for international students (Studienwerk). Для иностранцев — только магистратура (Master only) и PhD (кроме медицины/стоматологии/ветеринарии); нужно проживать в Германии на период учёбы и планировать возврат на родину. Немецкий B2, левые/социально-политические ценности фонда, интервью.", funding: "Стипендия по стандартным ставкам немецких фондов (BMBF): ~€992/мес магистратура, ~€1 450/мес PhD + доплаты на страховку; обучение бесплатно.", source_url: "https://www.rosalux.de/en/foundation/studienwerk" },
    { id: "fnf_intl", name: "Friedrich-Naumann-Stiftung (Германия)", country: "Германия", cc: "de", levels: ["master", "phd"], baseAdm: .12, baseSch: .12, req: { academics: 7, language: 6.5, budget: 0 }, deadline: "30 апреля", note: "Официально: Friedrich-Naumann-Stiftung für die Freiheit — Stipendium für ausländische Studierende und Promovierende. Иностранцы — только очная магистратура или PhD в Германии; до начала выплат нельзя жить в Германии >15 месяцев (кроме учёбы). Заявка и собеседование полностью на немецком; либеральный фонд (СвДП).", funding: "€992/мес (магистратура), до €1 500/мес (PhD) + доплаты на супруга €276 и ребёнка €259, медстраховка. Обучение бесплатно.", source_url: "https://www.freiheit.org/scholarships" },
    { id: "daad_master", name: "DAAD Master Studies (все дисциплины)", country: "Германия", cc: "de", levels: ["master"], baseAdm: .22, baseSch: .22, req: { academics: 7.5, language: 6.5, budget: 0 }, deadline: "осень (обычно окт–ноя, approx) — через DAAD Information Centre Алматы; даты о…", note: "Официально: DAAD Study Scholarships — Master Studies for All Academic Disciplines. Подача через DAAD-портал и офис в Казахстане; нужен диплом бакалавра не старше 6 лет, отличная успеваемость, мотивация; часто требуют одновременно подать в вузы. Не путать с EPOS/Helmut-Schmidt (уже в каталоге).", funding: "€992/мес на 10–24 мес + медстраховка, проездной грант, при необходимости доплата на аренду/семью, оплата языкового курса; обучение в гос. вузах бесплатно.", source_url: "https://www.daad.de/en/studying-in-germany/scholarships/daad-scholarships/" },
    { id: "daad_phd", name: "DAAD Research Grants (PhD)", country: "Германия", cc: "de", levels: ["phd"], baseAdm: .18, baseSch: .18, req: { academics: 7.5, language: 6.5, budget: 0 }, deadline: "осень (approx, по стране — см. DAAD Алматы); дедлайны публикуются ежегодно во…", note: "Официально: DAAD Research Grants — Doctoral Programmes in Germany. Нужны диплом магистра, письмо-согласие научного руководителя в Германии и проработанный исследовательский план; отбор комиссией DAAD. Доступно гражданам почти всех стран, включая Казахстан.", funding: "€1 300/мес до 4 лет + медстраховка, проездной грант, исследовательская надбавка €460/год, доплата на аренду и семью, оплата языкового курса.", source_url: "https://www2.daad.de/deutschland/stipendium/datenbank/en/21148-scholarship-database/?detail=57135739" },
    { id: "ista_phd", name: "ISTA PhD (Австрия)", country: "Австрия", cc: "at", levels: ["phd"], baseAdm: .1, baseSch: .95, req: { academics: 8.5, language: 7, budget: 0 }, deadline: "8 января", fields: ["sci", "it", "eng"], note: "Официально: ISTA PhD Program (Institute of Science and Technology Austria). Можно поступать сразу после бакалавра; треки: биология, химия/материалы, CS, data science, математика, нейронауки, физика. Очень конкурентный отбор с интервью в кампусе под Веной.", funding: "Полностью оплачиваемая позиция: зарплата €3 053–3 673/мес брутто (2026), полное соцстрахование; обучение и подача бесплатны.", source_url: "https://phd.pages.ista.ac.at/phd-application-admission/" },
    { id: "unige_excellence", name: "Excellence Master Fellowships (Женева)", country: "Швейцария", cc: "ch", levels: ["master"], baseAdm: .15, baseSch: .15, req: { academics: 8, language: 6.5, budget: 0 }, deadline: "28 февраля (ориентировочно)", fields: ["sci"], note: "Официально: University of Geneva — Excellence Master Fellowships (Faculty of Science). Только факультет наук: астрономия, биология, химия/биохимия, CS, математика, физика, фармацевтика, науки о Земле. Отбор по досье (CV, транскрипт, мотивация, 2 рекомендации); продление после 1-го семестра при хороших оценках.", funding: "CHF 10 000–15 000 в год на весь срок магистратуры (3–4 семестра), без преподавательских обязанностей; плата за обучение в UNIGE — CHF 500/семестр.", source_url: "https://www.unige.ch/sciences/en/enseignements/formations/masters/excellencemasterfellowships" },
    { id: "unil_master", name: "UNIL Master's Grant (Лозанна)", country: "Швейцария", cc: "ch", levels: ["master"], baseAdm: .08, baseSch: .08, req: { academics: 8, language: 6.5, budget: 0 }, deadline: "1 ноября", note: "Официально: Unil Master's Scholarship (UNIL Master's grants, Université de Lausanne). ~10 стипендий в год, только для выпускников зарубежных вузов с очень высокими оценками. Не для медицины, педагогики и большинства юридических магистратур; 2 рекомендательных письма напрямую от авторов.", funding: "CHF 1 600/мес на нормативный срок магистратуры + освобождение от платы за обучение (остаётся CHF 80/семестр). Не покрывает всю стоимость жизни.", source_url: "https://www.unil.ch/unil/en/home/menuinst/etudier/mobilite-et-echange/etudiantes-et-etudiants-internationaux/etudiantes-internationaux-reguliers/bourse-de-master.html" },
    { id: "iheid", name: "Geneva Graduate Institute (IHEID)", country: "Швейцария", cc: "ch", levels: ["master"], baseAdm: .2, baseSch: .2, req: { academics: 7.5, language: 7, budget: 3 }, deadline: "15 января (ориентировочно)", fields: ["hum", "law", "bus"], note: "Официально: Geneva Graduate Institute (IHEID) — Scholarships and financial aid for Master programmes. Отдельно подавать не нужно — заявка на финансовую помощь идёт в общей анкете; решение по сочетанию академических успехов и финансовой нужды. Профиль: международные отношения, развитие, право, экономика.", funding: "Полная или частичная стипендия (по формулировке института — максимум CHF 20 000 на два года) и/или снижение платы за обучение; институт тратит >CHF 2 млн в год на поддержку студентов.", source_url: "https://www.graduateinstitute.ch/fees-financial-aid" },
    { id: "leiden_lexs", name: "Leiden Excellence Scholarship (LExS)", country: "Нидерланды", cc: "nl", levels: ["master"], baseAdm: .1, baseSch: .1, req: { academics: 8.5, language: 7, budget: 0 }, deadline: "1 декабря", note: "Официально: Leiden University Excellence Scholarship (LExS). Только для не-EEA студентов очной магистратуры (кроме обычных LLM и MSc юрфака); ~25 стипендий на >1000 заявок. Не полная стипендия — нужно доказать остаток средств для визы.", funding: "Фиксированные суммы к оплате обучения: €10 000 / €15 000 / €17 500 / €18 500 / €19 000 (из ~€20–25 тыс. non-EU tuition); проживание не покрывается.", source_url: "https://www.universiteitleiden.nl/en/scholarships/sea/leiden-university-excellence-scholarship-lexs" },
    { id: "um_high_potential", name: "Maastricht NL-High Potential", country: "Нидерланды", cc: "nl", levels: ["master"], baseAdm: .08, baseSch: .08, req: { academics: 8.5, language: 7, budget: 0 }, deadline: "1 февраля", note: "Официально: UM NL-High Potential Scholarship (Maastricht University). Только для не-EU/EEA, возраст до 35 лет на 1 сентября, GPA ≥7.5/10, желательно без имеющейся магистратуры; сначала нужно полностью подать в программу через Studielink. Выигрывают ~2% заявителей.", funding: "Полное покрытие: на проживание €20 150 (13 мес) или €38 750 (25 мес) + плата за обучение, виза, медстраховка.", source_url: "https://www.maastrichtuniversity.nl/studeren/toelating-inschrijving/financing-your-studies/scholarships/maastricht-university-nl-high" },
    ...
    { id: "master_mind", name: "Master Mind (Фландрия, Бельгия)", country: "Бельгия", cc: "be", levels: ["master"], baseAdm: .1, baseSch: .1, req: { academics: 8.5, language: 7, budget: 2 }, deadline: "15 января (ориентировочно)", note: "Официально: Master Mind Scholarships (Government of Flanders). Открыто всем гражданствам, кроме России; нужен GPA ≥3.5/4.0 и IELTS 7.0. Подаёте через фламандский вуз (каждый выдвигает до 20 кандидатов) — сначала заявка на магистратуру, потом номинация.", funding: "€10 225 в год + освобождение от платы за обучение (tuition fee waiver) на 1 год (60 ECTS) или 2 года (120 ECTS).", source_url: "https://www.studyinflanders.be/scholarships/master-mind-scholarships/eligibility-criteria" },
    { id: "boutmy", name: "Émile Boutmy (Sciences Po)", country: "Франция", cc: "fr", levels: ["bachelor", "master"], baseAdm: .2, baseSch: .2, req: { academics: 7.5, language: 6.5, budget: 2 }, deadline: "1 февраля", fields: ["hum", "law", "bus"], note: "Официально: Émile Boutmy Scholarship (Sciences Po). Только для граждан не-ЕС, чья семья не платит налоги в ЕС, впервые поступающих в Sciences Po; учитываются и доход семьи, и academic excellence. Нельзя подать после зачисления — только в анкете поступления.", funding: "Бакалавриат: полное освобождение от tuition или скидка €9 500/год; магистратура: скидка €18 500/год на оба года. Возможны допвыплаты на проживание отдельным спонсорским стипендиатам.", source_url: "https://www.sciencespo.fr/students/en/fees-funding/bursaries-financial-aid/emile-boutmy-scholarship/" },
    { id: "paris_saclay", name: "Paris-Saclay International Master's", country: "Франция", cc: "fr", levels: ["master"], baseAdm: .18, baseSch: .18, req: { academics: 8, language: 6.5, budget: 2 }, deadline: "31 марта (ориентировочно)", note: "Официально: Université Paris-Saclay International Master's Scholarships Program. Иностранцы до 30 лет, впервые учащиеся во Франции, зачисленные на магистратуру Paris-Saclay; кандидатуру выдвигает координатор программы. Нельзя совмещать с Eiffel/France Excellence/Erasmus Mundus.", funding: "€10 000 в год (на M1 и/или M2, продлевается на 2-й год) + до €900/год на дорогу и визу; обучение в гос. вузе ~€250/год.", source_url: "https://www.universite-paris-saclay.fr/en/admission/bourses-et-aides-financieres/international-masters-scholarships-program" },
    { id: "ens_intl", name: "ENS International Selection (Париж)", country: "Франция", cc: "fr", levels: ["master"], baseAdm: .05, baseSch: .95, req: { academics: 9, language: 7, budget: 0 }, deadline: "15 декабря (ориентировочно)", fields: ["sci", "hum"], note: "Официально: ENS International Selection (École normale supérieure – PSL, Paris). Возраст до 26 лет на 1 декабря, минимум 1–2 года бакалавриата в зарубежном вузе, нельзя жить во Франции >10 мес в год отбора и подавать повторно. Письменные и устные экзамены в Париже; крайне конкурентно.", funding: "€1 000/мес в течение 3 лет + комната в кампусе ENS; обучение бесплатно (диплом ENS + магистратура).", source_url: "https://www.ens.psl.eu/en/academics/admissions/international-selection" },
    { id: "ampere_lyon", name: "Ampère Excellence (ENS de Lyon)", country: "Франция", cc: "fr", levels: ["master"], baseAdm: .08, baseSch: .08, req: { academics: 8.5, language: 7, budget: 0 }, deadline: "23 января", note: "Официально: Ampère Scholarships of Excellence (ENS de Lyon). Для иностранных студентов, поступающих в магистратуру ENS Lyon по точным наукам, искусствам и гуманитарным наукам; заявка на стипендию подаётся вместе с заявкой на магистратуру. Результаты в середине марта.", funding: "€1 000/мес на 12 месяцев (1 учебный год), продляемо на M2 при условиях; обучение в ENS ~€250/год.", source_url: "https://www.ens-lyon.fr/en/studies/admissions/application-masters-degrees-and-scholarships" },
    { id: "iyt_italy", name: "Invest Your Talent in Italy (IYT)", country: "Италия", cc: "it", levels: ["master"], baseAdm: .2, baseSch: .2, req: { academics: 7, language: 6.5, budget: 2 }, deadline: "11 мая (ориентировочно)", fields: ["eng", "it", "bus", "art", "sci"], note: "Официально: Invest Your Talent in Italy (IYT) — MAECI / Uni-Italia. Казахстан входит в список стран IYT. Только англоязычные магистратуры-партнёры по инженерии/IT/экономике/дизайну; отбор по академическим результатам и мотивации, обязателен интерншип.", funding: "€10 800 (выплаты поквартально, ~9 мес/год) + освобождение от платы за обучение (остаются ~€156 регионального сбора) + курс итальянского + обязательная стажировка в итальянской компании.", source_url: "https://www.unipi.it/en/education/registration/enrolment-and-registration/enrolment-for-international-students/invest-your-talent-in-italy-scholarships/" },
    { id: "unibo_talents", name: "International Talents @Unibo (Болонья)", country: "Италия", cc: "it", levels: ["master"], baseAdm: .2, baseSch: .2, req: { academics: 7.5, language: 6.5, budget: 2 }, deadline: "30 мая (ориентировочно)", note: "Официально: International Talents @Unibo — study grants for international students (University of Bologna). Для первокурсников магистратуры с дипломом, полученным вне итальянской системы (гражданство не важно). Ранжирование строго по GRE General (мин. V+Q 290, AW 3.0) — нужно сдать тест заранее. Есть требование по доходу семьи (ISEE €16 000–35 000) и возраст до 30 лет.", funding: "30 грантов по €6 500 в год на 2 года + полное освобождение от платы за обучение (остаётся ~€157 сборов).", source_url: "https://bandi.unibo.it/s/diri/bando-international-talents-unibo-borse-di-studio-per-studenti-internazionali-che-si-immatricolano-ai-corsi-di-laurea-magistrale-dell-universita-di-bologna-per-l-a-a-2025-26/call-for-application/en-bando_international-talents-2526_17-1-25.pdf/@@download/file/EN%20BANDO_INTERNATIONAL%20TALENTS%202526_17-1-25.pdf" },
    { id: "padua_excellence", name: "Padua International Excellence", country: "Италия", cc: "it", levels: ["bachelor", "master"], baseAdm: .15, baseSch: .15, req: { academics: 8, language: 6.5, budget: 0 }, deadline: "2 февраля (ориентировочно)", note: "Официально: Padua International Excellence Scholarship Programme (Università di Padova). Отдельно не подаётся — рассматриваются все, кто подал в англоязычную программу в первом раунде (иностранный диплом/аттестат, не резидент Италии). Нужно набрать ≥20 ECTS к 30 ноября, иначе стипендия отзывается.", funding: "€8 000 брутто в год + освобождение от платы за обучение (остаются региональный сбор и гербовая марка); до 2 лет магистратура / 3 года бакалавриат; до 68 стипендий.", source_url: "https://www.unipd.it/en/padua-excellence" },
    { id: "topolito", name: "TOPoliTO (Politecnico di Torino)", country: "Италия", cc: "it", levels: ["master"], baseAdm: .1, baseSch: .1, req: { academics: 8, language: 6.5, budget: 0 }, deadline: "31 августа (ориентировочно)", fields: ["eng", "it"], note: "Официально: TOPoliTO Scholarships (Politecnico di Torino). ~10 стипендий (6 инженерия, 4 архитектура) для обладателей зарубежного бакалавра, не живших в Италии последние 5 лет; ранжирование по GRE. Небольшая программа — рассматривать как дополнение к DSU/EDISU (уже в каталоге).", funding: "€8 000 брутто в год (~€7 370 нетто) на 2 года магистратуры; плата за обучение, дорога и жильё НЕ покрываются (tuition для иностранцев по доходу семьи, часто снижена).", source_url: "https://www.polito.it/en/education/international-students/financial-aid" },
    { id: "inphinit", name: "«la Caixa» INPhINIT PhD (Испания)", country: "Испания", cc: "es", levels: ["phd"], baseAdm: .08, baseSch: .95, req: { academics: 9, language: 7, budget: 0 }, deadline: "28 января (ориентировочно)", fields: ["sci", "eng", "it", "med"], note: "Официально: \"la Caixa\" Foundation Doctoral INPhINIT Fellowships — Incoming. Любое гражданство; нельзя жить/работать в Испании или Португалии >12 мес за последние 3 года и иметь >4 лет исследовательского опыта. Только центры с аккредитацией Severo Ochoa / María de Maeztu / ISCIII (или португальские «excellent»); STEM-профиль, интервью.", funding: "Полная оплата труда и tuition за докторантуру + бюджет на исследования; 30 стипендий, до 4 лет (в прошлые годы ~€35 800/год + €3 564/год на расходы).", source_url: "https://lacaixafoundation.org/en/doctoral-inphinit-fellowships-incoming-call" },
    { id: "kth_scholarship", name: "KTH Scholarship (Швеция)", country: "Швеция", cc: "se", levels: ["master"], baseAdm: .08, baseSch: .08, req: { academics: 8.5, language: 7, budget: 0 }, deadline: "15 января", fields: ["eng", "it", "sci"], note: "Официально: KTH Scholarship (KTH Royal Institute of Technology). Только для fee-paying (не-EU) студентов, поставивших KTH-программу первым приоритетом на universityadmissions.se и оплативших сбор. В 2025 получили ~8% (65 из 803 заявителей).", funding: "Полное покрытие платы за обучение (~SEK 155 000–200 000/год) на 1-й и 2-й год; проживание не покрывается.", source_url: "https://www.kth.se/en/studies/master/admissions/scholarships/kth-scholarship-1.72827" },
    { id: "lund_global", name: "Lund Global Scholarship (Швеция)", country: "Швеция", cc: "se", levels: ["bachelor", "master"], baseAdm: .12, baseSch: .12, req: { academics: 8, language: 6.5, budget: 2 }, deadline: "16 февраля", note: "Официально: Lund University Global Scholarship. Только граждане вне EU/EEA/Швейцарии, обязанные платить tuition, подавшие Lund первым приоритетом; отбор по академическим результатам, финансовая нужда не учитывается. Мотивационное письмо до 600 слов.", funding: "Покрытие 25–100% платы за обучение (сумма зависит от факультета); проживание не покрывается.", source_url: "https://www.lunduniversity.lu.se/admissions/scholarships-and-awards/lund-university-global-scholarship" },
    { id: "uppsala_global", name: "Uppsala Global Scholarship (Швеция)", country: "Швеция", cc: "se", levels: ["master"], baseAdm: .08, baseSch: .08, req: { academics: 8.5, language: 7, budget: 0 }, deadline: "2 февраля", note: "Официально: Uppsala University Global Scholarship (Master's). Для fee-paying студентов вне EU/EEA; отдельная заявка на стипендию после подачи в программу через universityadmissions.se. Отбор по академическим результатам; программы Uppsala первым приоритетом.", funding: "Полное покрытие платы за обучение на весь срок магистратуры; проживание не покрывается.", source_url: "https://www.uu.se/en/study/masters-studies/scholarships/uppsala-university-scholarships" },
    { id: "chalmers_ipoet", name: "Chalmers IPOET / Avancez (Швеция)", country: "Швеция", cc: "se", levels: ["master"], baseAdm: .15, baseSch: .15, req: { academics: 8, language: 6.5, budget: 2 }, deadline: "15 января", fields: ["eng", "it", "sci"], note: "Официально: Chalmers IPOET and Avancez Scholarships (Chalmers University of Technology). Доступно всем fee-paying (не-EU) студентам, подавшим на магистратуру Chalmers; нужен номер заявки universityadmissions.se. Финансовое положение не учитывается — только академические достижения.", funding: "Снижение платы за обучение на 75% на 4 семестра (IPOET — финансирует правительство Швеции; Avancez — Chalmers); при отличных результатах 1-го года — до 85%. Проживание не покрывается.", source_url: "https://www.chalmers.se/en/education/application-and-admission/scholarships-for-fee-paying-students/" },
    { id: "ki_global", name: "KI Global Master's (Karolinska)", country: "Швеция", cc: "se", levels: ["master"], baseAdm: .06, baseSch: .06, req: { academics: 8.5, language: 7, budget: 0 }, deadline: "15 февраля", fields: ["med"], note: "Официально: KI Global Master's Scholarship for fee-paying students (Karolinska Institutet). Только для fee-paying студентов, поставивших программу KI первым приоритетом; ~10–12 стипендий в год, по одной на программу (лучший по KI CV-форме). Медицина/биомедицина/общественное здоровье.", funding: "Полное покрытие платы за обучение на весь срок магистратуры; проживание, дорога и жильё не покрываются.", source_url: "https://education.ki.se/bachelors-masters-studies/scholarships/the-ki-global-masters-scholarships-for-fee-paying-students" },
    { id: "imperial_phd", name: "Imperial President's PhD (Лондон)", country: "Великобритания", cc: "gb", levels: ["phd"], baseAdm: .08, baseSch: .08, req: { academics: 9, language: 7, budget: 0 }, deadline: "12 января (ориентировочно)", note: "Официально: President's PhD Scholarships (Imperial College London). Без ограничений по гражданству; нужны диплом с отличием (first class / distinction) и предварительное согласие научного руководителя. Заявка через обычный doctoral admissions с research proposal.", funding: "Полная оплата tuition + стипендия £26 500/год (2026–27) + £2 000/год на расходные материалы в первые 3 года; 50 стипендий.", source_url: "https://www.imperial.ac.uk/study/fees-and-funding/postgraduate-doctoral/grants-scholarships/presidents-phd/" },
    { id: "ucl_res", name: "UCL Research Excellence (PhD)", country: "Великобритания", cc: "gb", levels: ["phd"], baseAdm: .08, baseSch: .08, req: { academics: 9, language: 7, budget: 0 }, deadline: "9 января (ориентировочно)", note: "Официально: UCL Research Excellence Scholarship (UCL-RES). Для кандидатов из любой страны, подавших полную заявку на PhD в UCL; нужен диплом уровня UK 2:1+. Отдельная заявка на стипендию, конкурс очень высокий.", funding: "Полная оплата tuition (Overseas) + стипендия £22 780/год (ставка 2025/26) на исследовательскую часть программы + до £1 200/год на исследования; 40 стипендий.", source_url: "https://www.ucl.ac.uk/scholarships/research-excellence-scholarship" },
    { id: "lse_gss", name: "LSE Graduate Support Scheme", country: "Великобритания", cc: "gb", levels: ["master"], baseAdm: .3, baseSch: .3, req: { academics: 7.5, language: 7, budget: 4 }, deadline: "23 апреля (ориентировочно)", fields: ["hum", "bus", "law"], note: "Официально: LSE Graduate Support Scheme (GSS). Открыт всем гражданствам на taught master's/diploma (кроме executive/модульных программ); оценивается финансовая нужда, а не успеваемость. Заявка через Graduate Financial Support после подачи на поступление; не влияет на решение о приёме.", funding: "£5 000–20 000 (need-based, разово на год) в дополнение к другим источникам; полный tuition не покрывает.", source_url: "https://www.lse.ac.uk/study-at-lse/Graduate/fees-and-funding/graduate-support-scheme" },
    { id: "warwick_phd", name: "Warwick Chancellor's PhD", country: "Великобритания", cc: "gb", levels: ["phd"], baseAdm: .08, baseSch: .08, req: { academics: 8.5, language: 7, budget: 0 }, deadline: "11 декабря (ориентировочно)", note: "Официально: Chancellor's International / Chancellor's Scholarships (University of Warwick, PGR). Любое гражданство и fee status; нужен оффер на PGR-программу Warwick на октябрь, отсрочка невозможна. Проект по любой дисциплине или междисциплинарный в рамках Research Spotlights.", funding: "Полная оплата academic fees + стипендия по ставке UKRI (~£20 780/год) на 3.5 года + разовый грант RTSG £5 000; иммиграционная поддержка.", source_url: "https://warwick.ac.uk/services/dc/schols_fund/scholarships_and_funding/" },
    { id: "cam_intl", name: "Cambridge International Scholarship", country: "Великобритания", cc: "gb", levels: ["phd"], baseAdm: .08, baseSch: .08, req: { academics: 9, language: 7.5, budget: 0 }, deadline: "3 декабря (ориентировочно)", note: "Официально: Cambridge International Scholarship (Cambridge Trust). Все страны, кроме UK/Ирландии, со статусом Overseas; отдельной заявки нет — отмечаете funding в общей аппликации в Cambridge до дедлайна по курсу. Решения март–июль; если не связались до конца июля — отказ.", funding: "Полная оплата University Composition Fee (International) + maintenance (~£20 000+/год) + иммиграционный медсбор; ~80 стипендий в год.", source_url: "https://www.student-funding.cam.ac.uk/fund/cambridge-international-scholarship-2024" },
    { id: "edinburgh_edcs", name: "Edinburgh Doctoral College (EDCS)", country: "Великобритания", cc: "gb", levels: ["phd"], baseAdm: .08, baseSch: .08, req: { academics: 8.5, language: 7, budget: 0 }, deadline: "31 января (ориентировочно)", note: "Официально: Edinburgh Doctoral College Scholarships (EDCS, University of Edinburgh). Открыто UK и overseas кандидатам на 1-й год PhD; нужен диплом уровня UK first/2:1. Сначала заявка на поступление, затем онлайн-заявка на стипендию через MyEd (Informatics и Physics рассматривают автоматически); в большинстве школ 1 стипендия.", funding: "Полная оплата tuition + стипендия по ставке UKRI (£20 780 в 2025–26) на 3–4 года (в зависимости от школы).", source_url: "https://registryservices.ed.ac.uk/student-funding/postgraduate/international/doctoral-college" },
    { id: "standrews_ug", name: "St Andrews International Excellence (бак.)", country: "Великобритания", cc: "gb", levels: ["bachelor"], baseAdm: .1, baseSch: .1, req: { academics: 8.5, language: 7, budget: 5 }, deadline: "27 января", note: "Официально: International Excellence Scholarship (University of St Andrews, undergraduate). Только один победитель среди overseas-абитуриентов (кроме медицины и совместного BA с William & Mary); заявка через портал после подачи на курс, победитель обязан быть Student Ambassador. Есть и частичные International Undergraduate Scholarships.", funding: "Полная оплата tuition на весь срок бакалавриата (одна стипендия в год); проживание не покрывается.", source_url: "https://www.st-andrews.ac.uk/study/scholarships/scholarships-catalogue/undergraduate-scholarships/international-excellence-scholarship/" },
    { id: "standrews_phd", name: "St Andrews World-Leading PhD", country: "Великобритания", cc: "gb", levels: ["phd"], baseAdm: .08, baseSch: .08, req: { academics: 8.5, language: 7, budget: 0 }, deadline: "20 января", note: "Официально: St Leonard's College World-Leading Doctoral Scholarships (University of St Andrews). Для любого fee status, включая Overseas; нужна поданная заявка на PhD в St Andrews. Отбор студентом-инициированных проектов (student-led) при поддержке школы/руководителя.", funding: "Полная оплата tuition + стипендия £20 467/год (2026–27); до 6 стипендий.", source_url: "https://www.st-andrews.ac.uk/study/fees-and-funding/scholarships/scholarships-catalogue/postgraduate-scholarships/world-leading-scholarships-student-led/" },
    { id: "ucd_global", name: "UCD Global Excellence (Дублин)", country: "Ирландия", cc: "ie", levels: ["bachelor", "master"], baseAdm: .25, baseSch: .25, req: { academics: 7.5, language: 6.5, budget: 3 }, deadline: "31 марта (ориентировочно)", note: "Официально: UCD Global Excellence Scholarships (University College Dublin). Только для абитуриентов со статусом non-EU fee; нужно иметь оффер на программу UCD и подать как можно раньше. Не продлевается автоматически — успеваемость проверяют каждый год.", funding: "50% или 100% платы за обучение (tuition ~€20–30 тыс./год) на бакалавриат и taught master's; проживание не покрывается; ежегодная переоценка.", source_url: "https://www.ucd.ie/global/study-at-ucd/scholarshipsfinances/scholarships/globalexcellencescholarships/" },
    { id: "fsv_scholars", name: "FSV UK Scholars (Карлов университет)", country: "Чехия", cc: "cz", levels: ["bachelor", "master"], baseAdm: .3, baseSch: .3, req: { academics: 7, language: 6.5, budget: 3 }, deadline: "30 апреля", fields: ["hum", "bus"], note: "Официально: FSV UK SCHOLARS Program — Faculty of Social Sciences, Charles University. Гражданство не ограничено; отбор по мотивационному эссе, рекомендации, оценкам и финансовому положению. Действует год, продление — через повторную заявку.", funding: "Единовременная выплата ок. 75 000 CZK (≈3 000 EUR) в год студентам платных англоязычных программ факультета социальных наук; освобождения от платы нет, но сумма покрывает около половины годовой платы; подавать заново каждый год.", source_url: "https://fsv.cuni.cz/en/admissions/scholarships-funding-and-fees/fsv-uk-scholars-program" },
    { id: "matfyz_tuition", name: "Matfyz Tuition Scholarships (Карлов университет)", country: "Чехия", cc: "cz", levels: ["bachelor", "master"], baseAdm: .25, baseSch: .25, req: { academics: 7.5, language: 6.5, budget: 3 }, deadline: "30 апреля", fields: ["it", "sci"], note: "Официально: Computer Science / Prague Mathematics / Prague Physics Tuition Fee Scholarships — Faculty of Mathematics and Physics, Charles University (Matfyz). Отдельная заявка на стипендию (CV, мотивационное письмо, 2 рекомендации) параллельно с поступлением; нельзя совмещать с другой стипендией. Мест очень мало, отбор по академическим результатам.", funding: "Покрытие платы за обучение: 7 100 EUR в год для студентов не из ЕС (4 200 EUR для ЕС) на весь срок — 3 года бакалавриата или 2 года магистратуры на англоязычных программах Computer Science; аналогичные схемы для математики и физики. До 6 мест на бакалавриат и 2 на магистратуру по CS.", source_url: "https://www.mff.cuni.cz/en/admissions/scholarships/cstf-scholarships-2026" },
    { id: "stars_phd", name: "STARS PhD (Карлов университет)", country: "Чехия", cc: "cz", levels: ["phd"], baseAdm: .2, baseSch: .95, req: { academics: 7.5, language: 6.5, budget: 0 }, deadline: "30 апреля (ориентировочно)", fields: ["sci"], note: "Официально: STARS PhD Programme — Faculty of Science, Charles University. Нужен диплом магистра по естественным наукам/медицине/фармации; выбираете до 3 проектов, отбор руководителем и интервью. Открыто для всех иностранцев.", funding: "Полностью финансируемые PhD-позиции: гарантированный минимум 20 500 CZK/мес (≈800 EUR) на 4 года, фактически часто выше за счёт грантов проектов; обучение без платы.", source_url: "https://stars-natur.cz/" },
    { id: "debrecen_intl", name: "University of Debrecen International", country: "Венгрия", cc: "hu", levels: ["bachelor", "master"], baseAdm: .35, baseSch: .35, req: { academics: 6.5, language: 6, budget: 3 }, deadline: "15 июня", note: "Официально: University of Debrecen International Scholarship (UD International Scholarship). Казахстан среди 100+ стран-участниц; нельзя быть уже зачисленным в венгерский вуз; только сентябрьский набор. Стипендия не покрывает проживание.", funding: "Скидка до 90% годовой платы за обучение (до 30% на медицине/стоматологии) на программах по инженерии, IT, естественным и аграрным наукам, здравоохранению и математике + медицинская страховка; размер зависит от оценок и вступительного экзамена.", source_url: "https://edu.unideb.hu/page.php?id=426" },
    { id: "corvinus_scholarship", name: "Corvinus Scholarship (Будапешт)", country: "Венгрия", cc: "hu", levels: ["master"], baseAdm: .2, baseSch: .2, req: { academics: 7.5, language: 6.5, budget: 3 }, deadline: "31 мая (ориентировочно)", fields: ["bus"], note: "Официально: Corvinus Scholarship — Corvinus University of Budapest (tuition-free places on MSc Management and Leadership, MSc Finance, International MBA). Только для самофинансируемых студентов (не Stipendium Hungaricum); стипендия не покрывает проживание. Отбор по академическим результатам, решение принимает президентский комитет.", funding: "Полное или частичное покрытие платы за обучение (до 100% семестровой платы) для студентов платных программ; до 20 мест на каждую из трёх магистерских программ; для сохранения — ≥54 кредитов за 2 семестра и средний балл ≥3,8.", source_url: "https://corvinus-university.dreamapply.com/news/new/50-full-tuition-scholarships-available-corvinus" },
    { id: "aubg", name: "AUBG (Болгария)", country: "Болгария", cc: "bg", levels: ["bachelor"], baseAdm: .3, baseSch: .3, req: { academics: 7, language: 6.5, budget: 3 }, deadline: "15 января", note: "Официально: American University in Bulgaria (AUBG) — Distinguished, AUBG Funded and Donor-Funded Scholarships. Все заявители автоматически рассматриваются на merit-стипендии; полных стипендий всего 9, для них нужны высокие оценки и тесты + лидерство. Для need-based нужны финансовые документы; лучшие шансы при подаче до 15 января.", funding: "9 полных стипендий (100% tuition) AUBG Distinguished Scholarship; AUBG Funded Scholarship до 40% платы автоматически по академическим данным; донорские стипендии 2 000–4 800 EUR/год, в т.ч. «Scholarships for International Students» для Восточной Европы и Центральной Азии и Huwiler/Khamatova для студентов из Центральной Азии (по нужде).", source_url: "https://www.aubg.edu/admissions/bachelors/cost-aid/scholarships/" },
    { id: "greece_mfa_ug", name: "МИД Греции — бакалавриат", country: "Греция", cc: "gr", levels: ["bachelor"], langYear: true, baseAdm: .25, baseSch: .85, req: { academics: 6, language: 3, budget: 2 }, deadline: "8 сентября (ориентировочно)", note: "Официально: Hellenic Ministry of Foreign Affairs — Undergraduate Scholarships in Greece for foreign nationals. Казахстан прямо указан в списке 33 стран; подача только через посольство/консульство Греции; нужна справка о постоянном проживании за пределами Греции ≥5 лет. Обучение на греческом — сначала языковой год.", funding: "50 полных стипендий: 650 EUR/мес, освобождение от платы за обучение, бесплатные учебники, при необходимости бесплатный год изучения греческого; на весь срок бакалавриата + 2 года.", source_url: "https://www.mfa.gr/missionsabroad/en/luxembourg-en/news/undergraduate-scholarships-in-greece-offered-by-the-hellenic-ministry-of-foreign-affairs-for-the-academic-year-20252026.html" },
    { id: "vu_waiver", name: "Vilnius University — освобождение от платы", country: "Литва", cc: "lt", levels: ["master", "bachelor"], baseAdm: .25, baseSch: .25, req: { academics: 7, language: 6.5, budget: 3 }, deadline: "1 июня (ориентировочно)", note: "Официально: Vilnius University — Tuition fee waivers for non-EU master's applicants + Faculty of Law special scholarship. Казахстан прямо назван в списке стран для юридической стипендии. Освобождения покрывают только обучение, не проживание; количество мест минимально, отбор по академическим результатам.", funding: "5 полных освобождений от платы за обучение на англо-/русскоязычных магистерских программах для выдающихся кандидатов не из ЕС; полное освобождение на BA Politics of Global Challenges и MA Eastern European and Russian Studies (IIRPS); Faculty of Law — 50–100% платы на International and European Law для граждан Казахстана и ещё 6 стран.", source_url: "https://admissions.vu.lt/all-news/study-without-financial-burden-vilnius-university-offers-a-variety-of-funding-opportunities-1" },
    { id: "vilniustech", name: "VILNIUS TECH (Литва)", country: "Литва", cc: "lt", levels: ["bachelor", "master"], baseAdm: .35, baseSch: .35, req: { academics: 6.5, language: 6, budget: 3 }, deadline: "20 апреля", fields: ["eng", "it", "bus"], note: "Официально: VILNIUS TECH (Vilnius Gediminas Technical University) — Tuition-free and partial (50%/25%) scholarships for international students. Отдельная заявка через apply.vilniustech.lt с мотивационным письмом (1 000–4 000 знаков) и 2 академическими рекомендациями; английский B2. Инженерия, IT, архитектура, бизнес.", funding: "100% освобождение от платы за обучение на весь срок (4 года бакалавриата / 2 года магистратуры при отсутствии задолженностей) для кандидатов с ≥80% максимальной оценки; 50% или 25% — при ≥70%. Проживание не покрывается.", source_url: "https://vilniustech.lt/en/international-students/full-time-students/scholarships/" },
    { id: "ktu_waiver", name: "KTU Каунас — освобождение от платы", country: "Литва", cc: "lt", levels: ["master"], baseAdm: .35, baseSch: .35, req: { academics: 6.5, language: 6, budget: 3 }, deadline: "1 июня", fields: ["eng", "it", "bus", "sci"], note: "Официально: Kaunas University of Technology (KTU) — Full or partial tuition fee waiver for international master's applicants. Отдельная заявка не нужна — отбор из всех поступающих; результаты в середине июля. Покрывает только обучение; для полного пакета можно параллельно подать на литовскую госстипендию.", funding: "Полное или частичное освобождение от платы за обучение (плата 4 690–7 116 EUR/год) для кандидатов с сильными академическими результатами и мотивацией; все подавшие заявку рассматриваются автоматически.", source_url: "https://admissions.ktu.edu/master/" },
    { id: "tlu_waiver", name: "Tallinn University — освобождение от платы", country: "Эстония", cc: "ee", levels: ["bachelor", "master"], baseAdm: .25, baseSch: .25, req: { academics: 7, language: 6.5, budget: 3 }, deadline: "15 апреля (ориентировочно)", fields: ["hum", "law", "art"], note: "Официально: Tallinn University — Tuition waivers for international students (School of Governance, Law and Society; Baltic Film, Media and Arts; Humanities). Освобождения назначаются по результатам вступительных испытаний, отдельная заявка не нужна; проживание не покрывается. Для сохранения скидки нужен минимальный GPA и очная форма.", funding: "Два 100%-х освобождения от платы в год в School of Governance, Law and Society (2 лучших по рейтингу приёма); 50–100% скидка со 2-го семестра на всех программах Baltic Film, Media and Arts; по два-четыре 50%-х освобождения на Liberal Arts in Humanities и Estonian Studies; 25–50% на Educational Innovation & Leadership.", source_url: "https://www.tlu.ee/en/scholarships" },
    { id: "heydar_aliyev", name: "Грант Гейдара Алиева (Азербайджан)", country: "Азербайджан", cc: "az", levels: ["bachelor", "master", "phd"], langYear: true, baseAdm: .18, baseSch: .9, req: { academics: 7, language: 3, budget: 0 }, deadline: "15 апреля", note: "Официально: Heydar Aliyev International Education Grant Program (Government of Azerbaijan). Открыт для граждан стран ОИС и Движения неприсоединения — Казахстан член ОИС. Обязательна официальная номинация госорганами своей страны; возраст до 35 (бакалавриат), 40 (магистратура), 45 (PhD); IELTS 5.0/5.5 для англоязычных программ.", funding: "100 грантов в год: полная плата за обучение и языковой подготовительный курс, авиабилеты в Баку и обратно раз в год, стипендия 800 AZN/мес (≈470 USD, 10 мес в году), 200 AZN/год на медицину, виза и регистрация.", source_url: "https://studyinazerbaijan.edu.az/heydar-aliyev-international-education-grant-program" },
    { id: "aua_armenia", name: "American University of Armenia (AUA)", country: "Армения", cc: "am", levels: ["bachelor", "master"], baseAdm: .3, baseSch: .3, req: { academics: 6.5, language: 6, budget: 3 }, deadline: "30 июня", note: "Официально: American University of Armenia (AUA) — International Scholarship (merit) and Need-Based Tuition Assistance. Нужна отдельная заявка на стипендию в Office of Financial Aid; покрывает не более половины платы, проживание не входит. Аккредитован в США (WASC), обучение на английском.", funding: "Международная merit-стипендия покрывает до 50% международной платы за обучение (по результатам вступительных тестов, заявки и эссе); дополнительно need-based tuition assistance, рассрочка и work-study до 20 ч/нед.", source_url: "https://finaid.aua.am/international-scholarships/" },
    { id: "uca_naryn", name: "University of Central Asia (UCA)", country: "Кыргызстан", cc: "kg", levels: ["bachelor"], baseAdm: .4, baseSch: .9, req: { academics: 6, language: 5.5, budget: 2 }, deadline: "14 февраля (ориентировочно)", note: "Официально: University of Central Asia (UCA, Naryn / Khorog) — Undergraduate admission with guaranteed financial aid. Вуз Ага-хана для Центральной Азии (кампусы Нарын, Хорог); нужны SAT/внутренний тест и отдельная заявка на financial aid (до апреля). Полное покрытие — только при подтверждённой финансовой нужде.", funding: "Приём по заслугам без учёта платёжеспособности: «никому не отказывают по финансовым причинам, а после зачисления финансовая помощь гарантирована»; пакет по нужде покрывает плату за обучение, проживание и питание в кампусе (доля зависит от дохода семьи).", source_url: "https://admissions.ucentralasia.org/" },
    { id: "osce_academy", name: "OSCE Academy (Бишкек)", country: "Кыргызстан", cc: "kg", levels: ["master"], baseAdm: .2, baseSch: .95, req: { academics: 7.5, language: 6.5, budget: 0 }, deadline: "1 апреля (ориентировочно)", fields: ["hum", "law", "bus"], note: "Официально: OSCE Academy in Bishkek — MA in Politics and Security / Economic Governance and Development / Human Rights and Sustainability. Только для граждан государств-участников ОБСЕ (Казахстан входит) и Афганистана; нужен IELTS 6.5 / TOEFL 90 или внутренний экзамен по английскому; работать полный день во время учёбы нельзя.", funding: "Обучение бесплатное (полный tuition waiver всем зачисленным) + ежемесячная стипендия на проживание в Бишкеке (в т.ч. 450 EUR на жильё); годичные англоязычные MA-программы.", source_url: "https://osce-academy.net/en/admission/faq/" },
    { id: "manas_kg", name: "Университет «Манас» (Кыргызстан)", country: "Кыргызстан", cc: "kg", levels: ["bachelor", "master", "phd"], langYear: true, baseAdm: .35, baseSch: .7, req: { academics: 6, language: 3, budget: 2 }, deadline: "10 июля", note: "Официально: Kyrgyz-Turkish Manas University (Кыргызско-Турецкий университет «Манас») — tuition-free study + merit stipend. Языки обучения — кыргызский и турецкий (без сертификата нужно сдать языковой экзамен или пройти подготовительный год); диплом должен быть признан в КР/Турции. Стипендия небольшая, но обучение полностью бесплатное.", funding: "Бесплатное обучение для всех зачисленных (включая иностранцев) + merit-стипендия: не менее 7 200 сом/мес в магистратуре и 9 600 сом/мес в докторантуре; бакалавриат — бесплатно по результатам вступительного экзамена университета.", source_url: "https://manas.edu.kg/en/news/7970" },
    { id: "yoneyama", name: "Rotary Yoneyama (Япония)", country: "Япония", cc: "jp", levels: ["bachelor", "master", "phd"], baseAdm: .12, baseSch: .12, req: { academics: 7.5, language: 5.5, budget: 3 }, deadline: "31 октября", note: "Официально: Rotary Yoneyama Memorial Scholarship (Overseas Candidates) / ロータリー米山記念奨学金. Нужен JLPT N3 или выше и уже полученное (или подтверждённое) зачисление в японский вуз; research students не подходят. Стипендиат должен прибыть в Японию до начала выплат, иначе теряет право.", funding: "100 000 JPY/мес (бакалавриат) или 140 000 JPY/мес (магистратура и докторантура), плюс до 250 000 JPY на дорогу в Японию. Обучение не покрывается.", source_url: "https://www.rotary-yoneyama.or.jp/english/overseas" },
    { id: "honjo", name: "Honjo International (Япония)", country: "Япония", cc: "jp", levels: ["master", "phd"], baseAdm: .06, baseSch: .06, req: { academics: 8.5, language: 6, budget: 3 }, deadline: "31 октября (ориентировочно)", note: "Официально: Honjo International Scholarship Foundation — Scholarship for Foreign Students. Всего ~5 стипендий на цикл, конкурс очень высокий. Нужно уже быть зачисленным (или иметь допуск) в магистратуру/докторантуру японского вуза; требуется 2-минутное видео о своём исследовании и очное собеседование в Токио.", funding: "210 000 JPY/мес при программе 1–2 года, 190 000 JPY/мес при 3 годах, 160 000 JPY/мес при 4–5 годах; выплачивается весь срок обучения. Обучение не покрывается.", source_url: "https://www.hisf.or.jp/en/scholarship/foreigner/" },
    { id: "kyoto_iup", name: "Kyoto iUP (Япония)", country: "Япония", cc: "jp", levels: ["bachelor"], baseAdm: .15, baseSch: .85, req: { academics: 8, language: 6.5, budget: 0 }, deadline: "3 декабря", note: "Официально: Kyoto University International Undergraduate Program (Kyoto iUP). Программа 6 мес. подготовки + 4 года бакалавриата; японский учится с нуля, но лекции старших курсов на японском. Все документы на английском; предварительный скрининг соответствия требованиям; отбор по документам и собеседованию.", funding: "Полное освобождение от вступительного взноса и полное/частичное освобождение от платы за обучение на 4,5 года; до 120 000 JPY/мес на 6-месячном подготовительном курсе; далее merit-стипендии от компаний-партнёров.", source_url: "https://www.iup.kyoto-u.ac.jp/apply/" },
    { id: "nagoya_g30", name: "Nagoya G30 (Япония)", country: "Япония", cc: "jp", levels: ["bachelor"], baseAdm: .2, baseSch: .2, req: { academics: 7.5, language: 6.5, budget: 3 }, deadline: "19 ноября", note: "Официально: Nagoya University Global 30 (G30) Undergraduate Scholarship. 10 англоязычных бакалавриатов, японский не требуется при поступлении. Отдельной заявки на стипендию нет — рассматриваются все поступающие (нужно приложить форму); учитываются успеваемость, внеучебная активность и финансовая потребность.", funding: "Полное освобождение от платы за обучение на 4 года + стипендия 500 000 JPY суммарно за 4 года. Также автоматическое рассмотрение на MEXT (University Recommendation: 117 000 JPY/мес + перелёт).", source_url: "https://admissions.g30.nagoya-u.ac.jp/studentlife/scholarships/" },
    { id: "gist_ug", name: "GIST для иностранцев (Корея)", country: "Корея", cc: "kr", levels: ["bachelor"], baseAdm: .2, baseSch: .95, req: { academics: 8, language: 6.5, budget: 0 }, deadline: "15 марта (ориентировочно)", fields: ["sci", "eng", "it"], note: "Официально: GIST International Undergraduate Admission — Full Scholarship. Только для иностранцев, оба родителя которых не корейцы. Отбор по SAT/AP/IB/ACT, аттестату и рекомендациям + опциональное телефонное интервью в мае; только STEM-направления.", funding: "Полная плата за обучение + освобождение от вступительного взноса, 530 000 KRW/мес (питание 270 000 + стипендия 130 000 + надбавка иностранцу 130 000), общежитие (двухместное), билет в одну сторону в Корею.", source_url: "https://service.gist.ac.kr/applicationGuide/Brochure%20of%20International%20Undergraduate%20Admission.pdf" },
    { id: "korea_univ_grad", name: "Korea University Global Leader", country: "Корея", cc: "kr", levels: ["master", "phd"], baseAdm: .3, baseSch: .3, req: { academics: 7.5, language: 6.5, budget: 3 }, deadline: "10 сентября (ориентировочно)", note: "Официально: Korea University Graduate School — Global Leader Scholarship (Type A) и стипендии Type B/C. Заявка на стипендию подаётся вместе с заявлением на поступление; нужны рекомендация кафедры и согласие декана. Для Type A — GPA ≥4.0/4.5 и TOEFL iBT 90+/IELTS 7.0+/TOPIK 6; нельзя совмещать с GKS.", funding: "Type A: 100% платы за обучение + вступительный взнос + 500 000 KRW/мес × 4 месяца; Type B (гуманитарные/социальные): 60% платы; Type C (естественные/инженерные): 65% платы. Действует на 1-й семестр, далее пересмотр по GPA.", source_url: "https://graduate2.korea.ac.kr/scholarship/scholarships.html" },
    { id: "sutd_rainmaker", name: "SUTD Rainmaker (Сингапур)", country: "Сингапур", cc: "sg", levels: ["bachelor"], baseAdm: .15, baseSch: .15, req: { academics: 8.5, language: 6.5, budget: 0 }, deadline: "2 марта (ориентировочно)", fields: ["eng", "it"], note: "Официально: SUTD Rainmaker (International) Scholarship. Для иностранцев и PR; нужны сильные A-level/IB/эквивалент, лидерство и общественная активность. Учтите: сама MOE Tuition Grant подразумевает обязательство отработать 3 года в сингапурской компании.", funding: "Субсидированная плата за обучение (после MOE Tuition Grant) до 4 лет + пособие S$10 000/год (S$5 000 за семестр) + до S$5 000 на зарубежную программу от 4 недель. Без бонда по стипендии.", source_url: "https://www.sutd.edu.sg/admissions/undergraduate/scholarship/sutd-administered/sutd-rainmaker-scholarship-intl/" },
    { id: "hku_ps", name: "HKU Presidential PhD", country: "Гонконг", cc: "hk", levels: ["phd"], baseAdm: .08, baseSch: .08, req: { academics: 9, language: 7, budget: 0 }, deadline: "1 декабря", note: "Официально: HKU Presidential PhD Scholar Programme (HKU-PS). Отдельной заявки нет — рассматриваются все поступающие на full-time PhD; шорт-лист приглашают на интервью. Рекомендуется параллельно подавать на HK PhD Fellowship Scheme; конкурс очень высокий.", funding: "Год 1 до ~HK$445 800 (далее ~HK$428 300/год): стипендия HK$28 700/мес, cash award HK$40 000 (затем HK$20 000/год), освобождение от composition fee HK$49 500/год, HK$14 400/год на поездки, гарантированное общежитие в 1-й год.", source_url: "https://gradsch.hku.hk/prospective_students/fees_scholarships_and_financial_support/hku_presidential_phd_scholar_programme" },
    { id: "griffith_vc", name: "Griffith Vice Chancellor's", country: "Австралия", cc: "au", levels: ["bachelor", "master"], baseAdm: .2, baseSch: .2, req: { academics: 7.5, language: 6.5, budget: 5 }, deadline: "28 ноября", note: "Официально: Griffith Vice Chancellor's International Scholarship. Сначала нужно получить Letter of Offer, затем подать заявку на стипендию с транскриптами и мотивационным письмом; порог GPA 6.0/7 (или эквивалент). Не для граждан Австралии/НЗ.", funding: "Скидка 50% с платы за обучение на весь срок программы (coursework, бакалавриат и магистратура) при сохранении GPA ≥5.5/7.", source_url: "https://www.griffith.edu.au/international/scholarships-finance/scholarships/vice-chancellors-international-scholarship" },
    { id: "otago_phd", name: "Otago Doctoral (Новая Зеландия)", country: "Новая Зеландия", cc: "nz", levels: ["phd"], baseAdm: .25, baseSch: .25, req: { academics: 8, language: 6.5, budget: 0 }, deadline: "1 марта", note: "Официально: University of Otago Doctoral Scholarship. Открыта иностранцам (PhD-иностранцы в НЗ платят по домашней ставке); заявка через eVision вместе с заявлением в докторантуру и оценкой кафедры. Вуз сейчас пересматривает схему — проверяйте актуальные условия.", funding: "NZ$34 128/год стипендия + освобождение от платы за обучение по ставке для домашних студентов на 36 месяцев (без student services fee и страховки). До 153 стипендий в год.", source_url: "https://www.otago.ac.nz/study/scholarships/database/university-of-otago-doctoral-scholarship" },
    { id: "knight_hennessy", name: "Knight-Hennessy (Stanford)", country: "США", cc: "us", levels: ["master", "phd"], baseAdm: .04, baseSch: .95, req: { academics: 9.5, language: 8, budget: 0 }, deadline: "6 октября", note: "Официально: Knight-Hennessy Scholars (Stanford University). Граждане всех стран. Первый бакалавр должен быть получен не ранее января 2020 (для когорты 2027). Нужно параллельно поступить в graduate-программу Stanford; крайне высокий конкурс (~1–2%).", funding: "Полное покрытие tuition и сборов на срок до 3 лет любой full-time graduate-программы Stanford (MBA, MS, PhD, JD, MD и др.) + стипендия на проживание и учебные расходы (сумма на сайте не указана) + ежегодный авиабилет + разовое пособие на переезд.", source_url: "https://knight-hennessy.stanford.edu/admission/preparing-your-applications/application-deadlines" },
    { id: "robertson", name: "Robertson Scholars (Duke / UNC)", country: "США", cc: "us", levels: ["bachelor"], baseAdm: .03, baseSch: .95, req: { academics: 9.5, language: 8.5, budget: 0, sat: 7 }, deadline: "15 ноября", note: "Официально: Robertson Scholars Leadership Program (Duke University / UNC Chapel Hill). Программа прямо принимает заявки от международных абитуриентов (единая анкета для всех). Отдельная заявка в Robertson + поступление в Duke или UNC; интервью финалистов. Студент сам должен обеспечить визу.", funding: "8 семестров: полное tuition, проживание и питание, большинство обязательных сборов; финансирование до 3 летних программ; средства на конференции и 2 семестра обучения за рубежом. ~25 первокурсников в год.", source_url: "https://robertsonscholars.org/apply/high-school-students/" },
    { id: "emory_scholars", name: "Emory Scholars (США)", country: "США", cc: "us", levels: ["bachelor"], baseAdm: .04, baseSch: .04, req: { academics: 9.5, language: 8.5, budget: 0, sat: 7 }, deadline: "15 ноября", note: "Официально: Emory University Scholar Programs (Woodruff, Emory Scholars и др.). «Все студенты независимо от гражданства» рассматриваются. Достаточно ответить «да» на вопрос о Scholar Programs в заявке до 15 ноября; ~175–200 финалистов из ~10 000, финалисты приезжают в кампус в марте.", funding: "Merit-стипендии от частичных до полного tuition (у топ-уровня — полное tuition, проживание и питание), возобновляемые на 8 семестров.", source_url: "https://apply.emory.edu/financial-aid/scholar-program.html" },
    { id: "washu_scholars", name: "WashU Signature Scholars", country: "США", cc: "us", levels: ["bachelor"], baseAdm: .04, baseSch: .04, req: { academics: 9.5, language: 8.5, budget: 0, sat: 7 }, deadline: "4 января", note: "Официально: WashU Signature Scholar Programs — Annika Rodriguez Scholars / Danforth Scholars (Washington University in St. Louis). Иностранцы допускаются только к программам Rodriguez и Danforth (Ervin — только для граждан/резидентов США). Нужны короткие эссе через портал Pathway и рекомендации; финалисты — интервью в марте.", funding: "Полное tuition + стипендия либо половина tuition (жильё не покрывается), на 4 года.", source_url: "https://scholars.washu.edu/about/scholar-program-faq/" },
    { id: "vanderbilt_merit", name: "Vanderbilt Merit Scholarships", country: "США", cc: "us", levels: ["bachelor"], baseAdm: .04, baseSch: .04, req: { academics: 9.5, language: 8.5, budget: 0, sat: 7 }, deadline: "1 декабря (ориентировочно)", note: "Официально: Vanderbilt Signature Merit Scholarships — Cornelius Vanderbilt / Ingram Scholars. FAQ прямо подтверждает: «international applicants are eligible to receive any of Vanderbilt's merit scholarships». Нужна отдельная заявка на стипендию через MyAppVU после подачи Common App; для Ingram — 2 рекомендации о волонтёрстве.", funding: "Полное tuition на 4 года + разовая летняя стипендия (учёба за рубежом, исследования или сервис-проект); >225 получателей суммарно.", source_url: "https://www.vanderbilt.edu/scholarships/faq.php" },
    { id: "bu_presidential", name: "BU Presidential (Бостон)", country: "США", cc: "us", levels: ["bachelor"], baseAdm: .1, baseSch: .1, req: { academics: 9, language: 8, budget: 6, sat: 6 }, deadline: "1 декабря", note: "Официально: Boston University Presidential Scholarship. Иностранные студенты прямо перечислены среди тех, кто может получить merit-стипендии; отдельной заявки нет — по обычной заявке, поданной до 1 декабря. Остальные ~50% tuition и проживание — за свой счёт.", funding: "Половина tuition (half-tuition), возобновляется до 4 лет. Прежняя Trustee Scholarship (полное tuition) на текущей официальной странице merit-стипендий больше не указана.", source_url: "https://www.bu.edu/admissions/tuition-aid/scholarships-financial-aid/first-year-merit/" },
    { id: "alabama_intl", name: "University of Alabama International", country: "США", cc: "us", levels: ["bachelor"], baseAdm: .5, baseSch: .6, req: { academics: 8, language: 7, budget: 5, sat: 7 }, deadline: "4 декабря", note: "Официально: University of Alabama International Freshman Scholarships (Presidential / Presidential Elite). Одна из немногих «предсказуемых» схем: стипендия начисляется автоматически по баллам SAT/ACT и GPA. Требуется сдать SAT/ACT; проживание и питание не покрываются (кроме Elite — жильё 1-й год по обычной цене).", funding: "Автоматические merit-стипендии по GPA 3.5+ и тестам: Presidential (SAT 1420+/ACT 32+) — $28 000 в год; Presidential Elite (SAT 1600/ACT 36, GPA 4.0) — полное tuition до 4 лет + $1 500/год + $2 000 на исследования; UA Scholar (SAT 1360+) — $24 000/год. Суммы одинаковы для out-of-state и иностранцев.", source_url: "https://afford.ua.edu/scholarships/international/" },
    { id: "iwu_intl", name: "Illinois Wesleyan (США)", country: "США", cc: "us", levels: ["bachelor"], baseAdm: .3, baseSch: .3, req: { academics: 7.5, language: 6.5, budget: 4 }, deadline: "1 марта", note: "Официально: Illinois Wesleyan University — International Student Merit Scholarships + need-based aid. Автоматическое рассмотрение всех подавших заявку; полное покрытие возможно только при комбинации merit + need-based (CSS Profile). Небольшой liberal-arts колледж, точная сумма зависит от оценок и тестов.", funding: "Merit-стипендии до $38 000 в год (возобновляются 4 года) автоматически по заявке; дополнительно need-based помощь для иностранцев по CSS Profile (гранты, займы, работа в кампусе).", source_url: "https://www.iwu.edu/international/scholarships.html" },
    { id: "minerva", name: "Minerva University (США)", country: "США", cc: "us", levels: ["bachelor"], baseAdm: .12, baseSch: .5, req: { academics: 8.5, language: 7.5, budget: 3 }, deadline: "8 ноября", note: "Официально: Minerva University — Need-based Financial Aid for international students. Заявку на fin. aid нужно подать ДО решения о приёме, если без помощи учиться невозможно. Формат: 4 года в 7 городах мира, стоимость заметно ниже американских вузов, но не бесплатно.", funding: "Need-based пакет независимо от гражданства: стипендии + низкопроцентные займы + work-study до ~$5 000/год. Полная стоимость 2027/28 — $31 300 (tuition $19 900 + residential $2 800 + services $5 600); full-ride не предоставляется, семья всегда вносит вклад.", source_url: "https://www.minerva.edu/tuition-aid/" },
    { id: "mccall_macbain", name: "McCall MacBain (McGill)", country: "Канада", cc: "ca", levels: ["master"], baseAdm: .05, baseSch: .95, req: { academics: 9, language: 7.5, budget: 0 }, deadline: "19 августа", note: "Официально: McCall MacBain Scholarships (McGill University). Бакалавр должен быть получен не ранее 5 лет назад (или возраст ≤30). Много этапов: заявка, региональные интервью, финальные интервью в Монреале; отдельно нужно поступить в программу McGill.", funding: "Полное tuition и сборы за всю нормативную длительность магистратуры/профессиональной программы McGill + CAD 2 300/мес в учебные семестры + грант на переезд в Монреаль + до CAD 5 000 на летние инициативы. Для иностранцев: 10 полных стипендий, 25 Finalist Awards по CAD 20 000/год (до 2 лет), 15 Regional Awards по CAD 10 000.", source_url: "https://mccallmacbainscholars.org/apply/" },
    { id: "york_intl", name: "York President's International", country: "Канада", cc: "ca", levels: ["bachelor"], baseAdm: .1, baseSch: .1, req: { academics: 9, language: 7, budget: 3 }, deadline: "27 января", note: "Официально: York University — President's International Scholarship of Excellence + International Scholarship of Distinction. PISE требует академического превосходства, волонтёрства и лидерства + номинации/рекомендации школы; автоматические стипендии дают лишь частичное покрытие (~10–25% стоимости).", funding: "PISE: CAD 180 000 (CAD 45 000/год × 4). Автоматические: York International Scholarship of Distinction — CAD 37 500 суммарно при среднем ≥85%; International Merit Award — CAD 25 000 при 80–84.9%; Entrance Award — CAD 5 000 при 75–79.9%. Гарантия общежития на 4 года.", source_url: "https://futurestudents.yorku.ca/financing-your-degree/international-scholarships" },
    { id: "dal_entrance", name: "Dalhousie Entrance Awards", country: "Канада", cc: "ca", levels: ["bachelor"], baseAdm: .35, baseSch: .35, req: { academics: 7.5, language: 6.5, budget: 5 }, deadline: "15 февраля", note: "Официально: Dalhousie University — General Entrance Award Program. Единая заявка на все entrance awards; крупные именные награды часто с региональными ограничениями (Карибы, Индия, Ямайка) — казахстанцу реально рассчитывать на общий пул по среднему баллу. Schulich Leader и Harrison McCain — только для канадцев.", funding: "2 000+ entrance awards ежегодно от CAD 1 000 до CAD 80 000 (в год / за 4 года, часть возобновляемые до 4 лет) по успеваемости (обычно ≥80% или 26 IB), лидерству, нужде и т.д. Иностранцы eligible.", source_url: "https://www.dal.ca/admissions/money_matters/awards-financial-aid/scholarships/prospective_students.html" },
    { id: "study_in_saudi", name: "Study in Saudi Arabia (гос. платформа)", country: "Саудовская Аравия", cc: "sa", levels: ["bachelor", "master", "phd"], langYear: true, baseAdm: .3, baseSch: .85, req: { academics: 6, language: 3, budget: 0 }, deadline: "6 октября (ориентировочно)", note: "Официально: Study in Saudi Arabia — стипендии Министерства образования КСА для иностранцев (единая платформа). Единый портал МОН КСА (studyinsaudi.sa), через который подаются заявки в KSU, IUM, KAU, UQU и др. Для арабоязычных программ обязателен подготовительный год арабского; возрастные лимиты по уровням (у KAU: магистратура ≤35, PhD ≤40).", funding: "Категории Fully Funded (полное покрытие обучения в госвузах КСА, по правилам МОН — стипендия, общежитие, билеты, медстраховка; суммы на платформе не указаны), Partially Funded и Self-Funded. Заявка в несколько вузов одновременно.", source_url: "https://studyinsaudi.sa/en" },
    { id: "ksu_intl", name: "King Saud University (Эр-Рияд)", country: "Саудовская Аравия", cc: "sa", levels: ["bachelor"], langYear: true, baseAdm: .3, baseSch: .85, req: { academics: 6, language: 3, budget: 0 }, deadline: "18 сентября (ориентировочно)", note: "Официально: King Saud University — International Scholarship Program (Riyadh). Возраст 17–25, аттестат не старше 5 лет со средним «очень хорошо», справка о несудимости, медосмотр, не получал ранее стипендию саудовского вуза. Отбор конкурсный по квотам на страну; сначала год арабского языка.", funding: "Освобождение от tuition, общежитие и льготное питание, ежемесячная стипендия + пособие за 2 месяца при приезде, авиабилет при зачислении и ежегодные билеты, медобслуживание студента и семьи, пособие на пересылку книг после выпуска (конкретные суммы в SAR в буклете не указаны).", source_url: "https://faculty.ksu.edu.sa/sites/default/files/KSU%20Scholarship%20Flyer%20EN.pdf" },
    { id: "alfaisal", name: "Alfaisal University (Эр-Рияд)", country: "Саудовская Аравия", cc: "sa", levels: ["bachelor"], baseAdm: .4, baseSch: .5, req: { academics: 7, language: 6, budget: 5 }, deadline: "28 июля", note: "Официально: Alfaisal University (Riyadh) — Merit / Need-based / Distinguished Science Scholarships. Частный вуз, скидки нельзя суммировать (merit ИЛИ need-based); максимум 50% и только для College of Science. Подходит как «бюджетный» вариант, но не как полная стипендия.", funding: "Частичные скидки: merit — 20% tuition (по SAT/ACT/IB, удержание GPA 3.25); need-based — 20% (GPA 2.75); Distinguished Science (College of Science) — 50% tuition. Проживание и стипендия не покрываются.", source_url: "https://admissions.alfaisal.edu/en/scholarship" },
    { id: "aus_presidents", name: "AUS President's Scholarship (Шарджа)", country: "ОАЭ", cc: "ae", levels: ["bachelor"], baseAdm: .08, baseSch: .08, req: { academics: 9, language: 7, budget: 3 }, deadline: "19 марта (ориентировочно)", note: "Официально: American University of Sharjah — President's Scholarship. Только для окончивших школу ЗА ПРЕДЕЛАМИ ОАЭ (казахстанские школы подходят): средний балл 98% за 10–11 классы, IELTS 7.0 / TOEFL iBT 94. Также автоматические merit-скидки 10–20% при 95%+.", funding: "100% tuition и лабораторных сборов, ежемесячная стипендия на весь срок (сумма не указана), общежитие, 3 авиабилета туда-обратно за время учёбы, медстраховка, отмена application fee.", source_url: "https://www.aus.edu/admissions/financial-grants-and-scholarships" },
    { id: "auc_excellence", name: "AUC Excellence (Каир)", country: "Египет", cc: "eg", levels: ["bachelor"], baseAdm: .2, baseSch: .2, req: { academics: 8, language: 6.5, budget: 3 }, deadline: "1 июня", note: "Официально: The American University in Cairo (AUC) — Excellence Scholarship Program. Есть отдельная категория «International Diversity» для иностранцев; 100% достижимо только при сочетании нескольких категорий и ранней подаче (до 1 марта — выше процент). Донорские стипендии с жильём и стипендией имеют свои критерии.", funding: "Суммируемые (stackable) стипендии от 20% до 100% tuition: Academic Achievement 20–60%, International Diversity 20–30%, Talents 20–30%, Leadership 20–30%, Liberal Arts 20–30%. Проживание не входит.", source_url: "https://www.aucegypt.edu/admissions/scholarships/excellence-program" },
    { id: "rotary_peace", name: "Rotary Peace Fellowship", country: "Международные", cc: "", levels: ["master"], baseAdm: .12, baseSch: .95, req: { academics: 7.5, language: 6.5, budget: 0 }, deadline: "31 мая", fields: ["hum", "law"], note: "Официально: Rotary Peace Fellowship (Rotary Foundation). Нужно ≥3 лет full-time опыта в сфере мира/развития (для сертификата — ≥5), TOEFL/IELTS, поддержка местного Rotary-дистрикта; учиться нужно вне своей страны. Члены Rotary и их дети/внуки не допускаются.", funding: "Полное покрытие tuition и сборов, проживание и питание, перелёт туда-обратно, расходы на стажировку и полевое исследование. До 50 master's-стипендий (15–24 мес. в Rotary Peace Centers: Duke/UNC, Bradford, Uppsala, ICU Tokyo, Queensland) и до 120 сертификатных (1 год).", source_url: "https://www.rotary.org/get-involved/our-programs/peace-fellowships/how-to-become-a-rotary-peace-fellow" }
  ];
